    ...
    <>
      ...
      <section className="p-4 m-4 sm:m-6 lg:mx-8 lg:my-4 my-2">
        ...
        <p className="mt-4 text-base">
          ...
          Learning, and Distributed/Parallel Computing, and I&apos;m currently
          doing my undergraduate honours project on using statistical methods
      ...
      <section className="px-4 py-6 m-4 sm:m-6 lg:mx-8 lg:my-4 my-2">
        ...
        <p className="mt-2 text-base">
          ...
          <Link href="/coursework" className="text-blue-600 underline">
            here
          </Link>
